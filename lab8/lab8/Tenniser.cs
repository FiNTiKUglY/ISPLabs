...
namespace lab8
{
    public class Tenniser : Athlete
    {
        ...
        public override void SmallInfo() => Console.WriteLine($"{ID}. Теннисист {Surname} {Name}");
        ...
        public void HitTraining()
        {
            ...
            Print?.Invoke($"Характеристики: удар +{cpow}, реакция +{creac}, владение ракеткой +{ccont}");
        ...
        public void PlayGame(Tenniser opponent)
        {
            ...
            if (compare > 40) Print?.Invoke($"{Surname} {Name} выиграл");
            else if (compare < -40) Print?.Invoke($"{opponent.Surname} {opponent.Name} выиграл");
            else
            {
                Random rnd = new Random();
                int result = rnd.Next(0, 2);
                if (result == 0) Print?.Invoke($"{Surname} {Name} выиграл в равной игре");
                else Console.WriteLine($"{opponent.Surname} {opponent.Name} выиграл в равной игре");
            }
        }

        public override string GetSpeciality() => "теннисист";
    }
}
